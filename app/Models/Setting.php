 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Setting whereVal($value)
 * @mixin \Eloquent
 */
class Setting extends Model
{
    ...
    {
        if( self::has($key) ) {
            return self::where('name', $key)->delete();
        }
    ...
    {
        return (boolean) self::getAllSettings()->where('name', $key)->count();
    }
